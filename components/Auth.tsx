  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-fade-in-fast">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-sm relative">
        ...
        <div className="p-8">
          <h2 className="text-2xl font-bold font-elsie text-center mb-2">
          ...
          {error && (
            <p className="bg-red-100 text-red-700 p-3 rounded-lg text-sm mb-4">{error}</p>
          )}
          {message && (
            <p className="bg-green-100 text-green-700 p-3 rounded-lg text-sm mb-4">{message}</p>
          )}
